...
import com.youdu.network.HttpConstants;
import com.youdu.network.RequestCenter;
import com.youdu.module.search.BaseSearchModel;
        ...
        RequestCenter.postRequest(HttpConstants.PRODUCT_LATESAT_UPDATE, null, new DisposeDataListener() {
            ...
            public void onSuccess(Object responseObj) {
                ...
                if (searchModel.data.uptime != -1) {
                    if (searchModel.data.uptime != spManager.getLong(SharedPreferenceManager.LAST_UPDATE_PRODUCT, -1)) {
            ...
            public void onSuccess(Object responseObj) {
                ...
                if (searchModel.data.list != null) {
                    ...
                    if (DBDataHelper.getInstance().insert(DBHelper.FUND_LIST_TABLE, searchModel.data.list)) {
                         ...
                         */
                        spManager.putLong(SharedPreferenceManager.LAST_UPDATE_PRODUCT, updateTime);
                        stopSelf();
                    } else {
