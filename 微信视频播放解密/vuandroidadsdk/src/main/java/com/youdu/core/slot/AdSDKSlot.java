...
import com.youdu.widget.VideoFullDialog.FullToSmallListener;
 ...
 * @date: 16/6/20
 */
public class AdSDKSlot implements ADVideoPlayerListener {
    ...
    public void updateAdInScrollView() {
        ...
        if (currentArea < SDKConstant.VIDEO_SCREEN_PERCENT) {
            ...
            mVideoView.setIsPausedClicked(false);
            return;
        }
        ...
        if (Utils.canAutoPlay(mContext, AdContextParameters.getCurrentSetting())
            ...
            pauseVideo(false);
            mVideoView.setIsPausedClicked(true); //不能自动播放则设置为手动暂停效果
        }
    }
